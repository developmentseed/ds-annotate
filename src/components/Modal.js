          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="relative p-6 flex-auto">
              <p className="my-4 text-md">
                DS-Annotate empowers users to draw intricate
                polygons over aerial imagery using the{" "}
                <a
              ...
              <ul className="list-disc list-inside space-y-2">
                <li className="text-md ">
                  <span className="font-bold">Magic Wand</span>:
                  Right-click on the area you want to select. You can click and drag
                  your mouse up/down to adjust the thresold. After making
                  your selection, press the <b><code>s</code></b> key to store the polygon.
                </li>
                <li className="text-md">
                  <span className="font-bold">
                    Segment Anything Model
                  </span>
                  : Click on the element in the imagery you want to get mapped. Then, press
                  the <b>Segment Anything</b> button to activate the model and start
                  getting the polygons. If you want more elements mapped, just click on them.
                </li>
              </ul>

              <p className="my-4 text-md">
                Both ways offer precise and efficient mapping,
                enhancing the overall annotation experience.
              </p>

              <p className="my-4 text-md">
                You can then download the polygons in GeoJSON
                format or export it to the Java OpenStreetMap Editor (JOSM).
              </p>
